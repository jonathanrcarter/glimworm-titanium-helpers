...
exports.newTable = function(xob,grouped) {
	...
	Titanium.API.debug("FFF");

	var style = (grouped) ? Titanium.UI.iPhone.TableViewStyle.GROUPED : Titanium.UI.iPhone.TableViewStyle.PLAIN;
...
exports.row = function(xob) {
	...
	var row = Ti.UI.createTableViewRow(jsonConcat({
		backgroundColor : ROWBGC,hasChild : true, height:'auto',
